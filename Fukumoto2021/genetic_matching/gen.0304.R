...
part <- 87:115 # indicates Feb.26 to March 25
part.adj <- part - 54
...
average.T <- apply(gm[gm$shutdown.0304 == 1, part], 2, mean, na.rm = T)
# average of outcome for matched and control municipalities
average.C <- apply(gm[gm$shutdown.0304 == 0, part], 2, mean, na.rm = T)
