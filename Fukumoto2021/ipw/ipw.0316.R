...
# 
# # Save Weights
# saveRDS(W.out, "ipw/results/w.out_0316.RDS")
...
# Load Weights
W.out <- readRDS("ipw/results/w.out_0316.RDS")
...
part <- 96:124 # indicates March 9 to April 6
part.adj <- part - 51 
...
models <- lapply(varlist, function(x){
  svyglm(substitute(i ~ shutdown.0316, list(i = as.name(x))), design = d.w)
})
