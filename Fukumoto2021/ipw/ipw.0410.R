...
# 
# # Save Weights
# saveRDS(W.out, "ipw/results/w.out_0410.RDS")
...
# Load Weights
W.out <- readRDS("ipw/results/w.out_0410.RDS")
...
part <- 121:149 # indicates April 3 to May 1
part.adj <- part - 51 
...
models <- lapply(varlist, function(x){
  svyglm(substitute(i ~ shutdown.0410, list(i = as.name(x))), design = d.w)
})
