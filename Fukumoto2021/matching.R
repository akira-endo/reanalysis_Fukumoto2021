...
savepdf <- function(file, width=7.28, height=7.08){ 
...
# Fukumoto_Fig1_a_source
Fukumoto_Fig1_a <- cbind(as.character(YMD[part.adj]), average.C, average.T, average.all.T[part.adj])
colnames(Fukumoto_Fig1_a) <- c("date", "outcome average in matched control municipalities", "outcome average in matched treated municipalities",
                         "outcome average in all treated municipalities")
write.csv(Fukumoto_Fig1_a, "output/Fukumoto_Fig1_a_source.csv", row.names = FALSE)

# Fukumoto_Fig1_b_source
Fukumoto_Fig1_b <- cbind(as.character(YMD[part.adj]), summary.Match.out[, 1], LB, UB)
colnames(Fukumoto_Fig1_b) <- c("date", "ATC", "lower bound of 95% confidence interval",
                         "upper bound of 95% confidence interval")
write.csv(Fukumoto_Fig1_b, "output/Fukumoto_Fig1_b_source.csv", row.names = FALSE)
...
# Fukumoto_Fig1_c_source
Fukumoto_Fig1_c <- cbind(as.character(YMD[part.adj]), average.C, average.T, average.all.T[part.adj])
colnames(Fukumoto_Fig1_c) <- c("date", "outcome average in matched control municipalities", "outcome average in matched treated municipalities",
                         "outcome average in all treated municipalities")
write.csv(Fukumoto_Fig1_c, "output/Fukumoto_Fig1_c_source.csv", row.names = FALSE)

# Fukumoto_Fig1_d_source
Fukumoto_Fig1_d <- cbind(as.character(YMD[part.adj]), summary.Match.out[, 1], LB, UB)
colnames(Fukumoto_Fig1_d) <- c("date", "ATC", "lower bound of 95% confidence interval",
                         "upper bound of 95% confidence interval")
write.csv(Fukumoto_Fig1_d, "output/Fukumoto_Fig1_d_source.csv", row.names = FALSE)
...
colnames(Fukumoto_Fig1_e) <- c("date", "outcome average in matched control municipalities", "outcome average in matched treated municipalities",
                         "outcome average in all treated municipalities")
write.csv(Fukumoto_Fig1_e, "output/Fukumoto_Fig1_e_source.csv", row.names = FALSE)
...
colnames(Fukumoto_Fig1_f) <- c("date", "ATC", "lower bound of 95% confidence interval",
                         "upper bound of 95% confidence interval")
write.csv(Fukumoto_Fig1_f, "output/Fukumoto_Fig1_f_source.csv", row.names = FALSE)

#### Inserted by Endo A
saveRDS(m.out,"output/mout_ATC0406.rds")
####
...
colnames(Fukumoto_Fig1_g) <- c("date", "outcome average in matched control municipalities", "outcome average in matched treated municipalities",
                         "outcome average in all treated municipalities")
write.csv(Fukumoto_Fig1_g, "output/Fukumoto_Fig1_g_source.csv", row.names = FALSE)
...
colnames(Fukumoto_Fig1_h) <- c("date", "ATC", "lower bound of 95% confidence interval",
                         "upper bound of 95% confidence interval")
write.csv(Fukumoto_Fig1_h, "output/Fukumoto_Fig1_h_source.csv", row.names = FALSE)

#### Inserted by Endo A
saveRDS(m.out,"output/mout_ATC0410.rds")
####
...
# abline(0,0,lty=2)
# 
# # Fukumoto_Fig1_i_source
# Fukumoto_Fig1_i <- cbind(as.character(YMD[part.adj]), average.C, average.T, average.all.T[part.adj])
# colnames(Fukumoto_Fig1_i) <- c("date", "outcome average in matched control municipalities", "outcome average in matched treated municipalities",
#                          "outcome average in all treated municipalities")
# write.csv(Fukumoto_Fig1_i, "output/Fukumoto_Fig1_i_source.csv", row.names = FALSE)
# 
# # Fukumoto_Fig1_j_source
# Fukumoto_Fig1_j <- cbind(as.character(YMD[part.adj]), summary.Match.out[, 1], LB, UB)
# colnames(Fukumoto_Fig1_j) <- c("date", "ATC", "lower bound of 95% confidence interval",
#                          "upper bound of 95% confidence interval")
# write.csv(Fukumoto_Fig1_j, "output/Fukumoto_Fig1_j_source.csv", row.names = FALSE)
# 
# # April 22
...
# abline(0,0,lty=2)
# 
# # Fukumoto_Fig1_k_source
# Fukumoto_Fig1_k <- cbind(as.character(YMD[part.adj]), average.C, average.T, average.all.T[part.adj])
# colnames(Fukumoto_Fig1_k) <- c("date", "outcome average in matched control municipalities", "outcome average in matched treated municipalities",
#                          "outcome average in all treated municipalities")
# write.csv(Fukumoto_Fig1_k, "output/Fukumoto_Fig1_k_source.csv", row.names = FALSE)
# 
# # Fukumoto_Fig1_l_source
# Fukumoto_Fig1_l <- cbind(as.character(YMD[part.adj]), summary.Match.out[, 1], LB, UB)
# colnames(Fukumoto_Fig1_l) <- c("date", "ATC", "lower bound of 95% confidence interval",
#                          "upper bound of 95% confidence interval")
# write.csv(Fukumoto_Fig1_l, "output/Fukumoto_Fig1_l_source.csv", row.names = FALSE)
# 
# # May 11
...
# abline(0,0,lty=2)
# 
# # Fukumoto_Fig1_m_source
# Fukumoto_Fig1_m <- cbind(as.character(YMD[part.adj]), average.C, average.T, average.all.T[part.adj])
# colnames(Fukumoto_Fig1_m) <- c("date", "outcome average in matched control municipalities", "outcome average in matched treated municipalities",
#                          "outcome average in all treated municipalities")
# write.csv(Fukumoto_Fig1_m, "output/Fukumoto_Fig1_m_source.csv", row.names = FALSE)
# 
# # Fukumoto_Fig1_n_source
# Fukumoto_Fig1_n <- cbind(as.character(YMD[part.adj]), summary.Match.out[, 1], LB, UB)
# colnames(Fukumoto_Fig1_n) <- c("date", "ATC", "lower bound of 95% confidence interval",
#                          "upper bound of 95% confidence interval")
# write.csv(Fukumoto_Fig1_n, "output/Fukumoto_Fig1_n_source.csv", row.names = FALSE)
