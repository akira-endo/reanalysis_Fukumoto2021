...
# estimate the ATE for every day from one week before (March 9) to three weeks after (April 6)
part <- 45:73 # indicates March 9 to April 6
...
# saveRDS(summary.FE.out, "fixed_effects/fe_0316.RDS")

# Load regression table
#summary.FE.out <- readRDS("fixed_effects/fe_0316.RDS")
