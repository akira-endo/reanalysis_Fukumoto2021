...
# estimate the ATE for every day from one week before (March 30) to three weeks after (April 27)
part <- 66:94 # indicates April 6 to April 30
...
# saveRDS(summary.FE.out, "fixed_effects/fe_0406.RDS")

# Load regression table
#summary.FE.out <- readRDS("fixed_effects/fe_0406.RDS")
